...
// Module: AdditionWorld.Level6
// Imports: Init MyNat.Addition AdditionWorld.Level2 AdditionWorld.Level4 AdditionWorld.Level5
#include <lean/lean.h>
...
lean_object* initialize_AdditionWorld_Level5(uint8_t builtin, lean_object*);
static bool _G_initialized = false;
LEAN_EXPORT lean_object* initialize_AdditionWorld_Level6(uint8_t builtin, lean_object* w) {
lean_object * res;
...
if (lean_io_result_is_error(res)) return res;
lean_dec_ref(res);
res = initialize_AdditionWorld_Level5(builtin, lean_io_mk_world());
if (lean_io_result_is_error(res)) return res;
lean_dec_ref(res);
