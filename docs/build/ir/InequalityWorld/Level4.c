...
// Module: InequalityWorld.Level4
// Imports: Init MyNat.Definition MyNat.Inequality Mathlib.Tactic.Use AdditionWorld.Level1
#include <lean/lean.h>
...
LEAN_EXPORT lean_object* initialize_InequalityWorld_Level4(uint8_t builtin, lean_object* w) {
lean_object * res;
