...
// Module: InequalityWorld.Level15
// Imports: Init MyNat.Definition MyNat.Addition MyNat.Inequality Mathlib.Tactic.Use AdditionWorld.Level2 AdditionWorld.Level3 InequalityWorld.Level2
#include <lean/lean.h>
...
lean_object* initialize_InequalityWorld_Level2(uint8_t builtin, lean_object*);
static bool _G_initialized = false;
LEAN_EXPORT lean_object* initialize_InequalityWorld_Level15(uint8_t builtin, lean_object* w) {
lean_object * res;
...
if (lean_io_result_is_error(res)) return res;
lean_dec_ref(res);
res = initialize_InequalityWorld_Level2(builtin, lean_io_mk_world());
if (lean_io_result_is_error(res)) return res;
lean_dec_ref(res);
