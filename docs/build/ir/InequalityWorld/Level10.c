...
// Module: InequalityWorld.Level10
// Imports: Init MyNat.Definition MyNat.Inequality Mathlib.Tactic.Use
#include <lean/lean.h>
...
LEAN_EXPORT lean_object* initialize_InequalityWorld_Level10(uint8_t builtin, lean_object* w) {
lean_object * res;
