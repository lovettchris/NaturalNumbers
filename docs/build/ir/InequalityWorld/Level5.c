...
// Module: InequalityWorld.Level5
// Imports: Init MyNat.Definition MyNat.Inequality Mathlib.Tactic.Use AdditionWorld.Level2
#include <lean/lean.h>
...
LEAN_EXPORT lean_object* initialize_InequalityWorld_Level5(uint8_t builtin, lean_object* w) {
lean_object * res;
