...
// Module: MultiplicationWorld.Level1
// Imports: Init MyNat.Addition MyNat.Multiplication
#include <lean/lean.h>
...
LEAN_EXPORT lean_object* initialize_MultiplicationWorld_Level1(uint8_t builtin, lean_object* w) {
lean_object * res;
