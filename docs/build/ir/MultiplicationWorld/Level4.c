...
// Module: MultiplicationWorld.Level4
// Imports: Init MyNat.Addition MyNat.Multiplication AdditionWorld.Level1 AdditionWorld.Level2
#include <lean/lean.h>
...
lean_object* initialize_AdditionWorld_Level1(uint8_t builtin, lean_object*);
lean_object* initialize_AdditionWorld_Level2(uint8_t builtin, lean_object*);
static bool _G_initialized = false;
LEAN_EXPORT lean_object* initialize_MultiplicationWorld_Level4(uint8_t builtin, lean_object* w) {
lean_object * res;
...
if (lean_io_result_is_error(res)) return res;
lean_dec_ref(res);
res = initialize_AdditionWorld_Level1(builtin, lean_io_mk_world());
if (lean_io_result_is_error(res)) return res;
lean_dec_ref(res);
